...
- [X] Switch from specialisations to different builds, specialisations should activate specific things (specialisations are too slow to build)
- [ ] Change gitauth to support ssh
- [ ] plasma manager for gui things (this should be a flake output rather than a specialisation)
- [ ] Zshell change
- [X] Remove home-builder
- [X] Move away from monolithic configuration
